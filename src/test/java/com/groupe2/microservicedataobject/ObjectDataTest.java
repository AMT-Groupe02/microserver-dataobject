...
public class ObjectDataTest {
    ...
    static final String KEY_NOT_EXIST = "AKeyThatDoesNotExists";
    ...
    void DoesObjectExist_RootObjectExistObjectDoesntExist_DoesntExist() {
        //given
        IDataObject object = new AwsDataObject(BUCKET_NAME + "/" + KEY_NOT_EXIST);
    ...
    void PublishObject_ObjectDoesntExist_ThrowException() {
        //given
        IDataObject notExistingObject = new AwsDataObject(BUCKET_NAME + "/" + KEY_NOT_EXIST);
        //when
        //then
