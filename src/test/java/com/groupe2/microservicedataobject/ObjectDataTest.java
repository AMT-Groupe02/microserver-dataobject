...
public class ObjectDataTest {
    ...
    static final String BUCKET_NAME = "amt.team02.diduno.education";
    ...
    static final IDataObject ALWAYS_EXIST_OBJECT = new AwsDataObject(BUCKET_NAME + "/" + ALWAYS_EXIST_KEY);
    ...
    @AfterEach
    void cleanUp() {
        IDataObject object = new AwsDataObject(BUCKET_NAME + "/" + IMAGE_KEY);
        try {
            object.delete();
    ...
    void DoesObjectExist_RootObjectExists_Exists() {
        // Ma classe n'a pas été prévu pour ce use case.
    }

    @Test
    void DoesObjectExist_RootObjectDoesntExist_DoesntExist() {
        //given
        IDataObject object = new AwsDataObject("TestRoot" + "/" + IMAGE_KEY);
    ...
    void DoesObjectExist_RootObjectExistObjectDoesntExist_DoesntExist() {
        //given
        IDataObject object = new AwsDataObject(BUCKET_NAME + "/" + ALWAYS_NOT_EXIST_KEY);
    ...
    void PublishObject_ObjectDoesntExist_ThrowException() {
        //given
        IDataObject notExistingObject = new AwsDataObject(BUCKET_NAME + "/" + ALWAYS_NOT_EXIST_KEY);
        //when
        //then
    ...
    void RemoveObject_SingleObjectDoesntExist_ThrowException() {
        ...
        //when
        //then
        assertThrows(Exception.class, object::delete);
    }
    ...
    void RemoveObject_FolderObjectExistWithoutRecursiveOption_ThrowException() {
        ...
        //given
        IDataObject object1 = new AwsDataObject(BUCKET_NAME + "/" + testFolder + "/object1");
        IDataObject object2 = new AwsDataObject(BUCKET_NAME + "/" + testFolder + "/object2");
        IDataObject folder = new AwsDataObject(BUCKET_NAME + "/" + testFolder);
    ...
    void RemoveObject_RootObjectNotEmptyWithoutRecursiveOption_ThrowException() {
        //given
        IDataObject object = new AwsDataObject(BUCKET_NAME);
        //when
        //then
        assertThrows(S3Exception.class, object::delete);
    }
